...
//motor 1 paramiters
int M1_max_speed = 1000;               // steps per second
int M1_max_acc = 500;                                 // steps per second second
int M1_min_speed = 100;
                                                                                            //motor 2 paramiters
int M2_max_speed = 1000;                 // steps per second
int M2_max_acc = 1000;                                 // steps per second second
int M2_min_speed = 200;
